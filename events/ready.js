...
module.exports = client => {
  ...
  console.log(`                                                                                                                             `)
||  client.user.setActivity(` n!help | n!invite | ${client.guilds.cache.size } Server | ${client.guilds.cache.reduce((a, b) => a + b.memberCount, 0).toLocaleString()} Users `, { type: "WATCHING"});
